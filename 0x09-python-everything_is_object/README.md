...
l = [1, 2, 3]
OAOAOAincrement(l)
OAOAOAOAOAOAprint(l)
OAOAOA```

* **18. List assignation**
OAOAOA  * [18-answer.txt](./18-answer.txt): What does this script print?
```
OAOAOAdef assign_value(n, v):
    n = v
...
OAOAOAOAOAOA* **19. Copy a list object**
OAOAOA  * [19-copy_list.py](./19-copy_list.py): Python function `def copy_list(l):` that returns a copy of a list.
OAOAOA
OAOAOA* **20. Tuple or not?**
OAOAOA  * [20-answer.txt](./20-answer.txt): Is `a` a tuple?
OAOAOA```
a = ()
OAOAOA```
...
```
OAOAOA
OAOAOAOAOAOAOAOAOA* **23. Tuple or not?**
OAOAOA  * [23-answer.txt](./23-answer.txt): Is `a` a tuple?
OAOAOA```
a = (1, )
OAOAOA```
...
OAOAOA```
OAOAOA
OAOAOA* **26. Empty is not empty**
...
* **27. Still the same**
OAOAOA  * [27-answer.txt](./27-answer.txt): Will the last line of this script print `139926795932424`?
```
>>> id(a)
139926795932424
>>> a
...
OAOAOA  * [104-line2.txt](./104-line2.txt): How many `int` objects are created by the execution of the second line in this script?
OAOAOA```
a = 1
b = 1
```
...
OAOAOA  * [104-line5.txt](./104-line5.txt): How many `int` objects are created by the execution of the last line in this script?
OAOAOA```
OAOAOAa = 1024
OAOAOAb = 1024
OAOAOAdel a
